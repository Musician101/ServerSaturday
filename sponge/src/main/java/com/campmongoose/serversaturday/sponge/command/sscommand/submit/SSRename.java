...
import com.campmongoose.serversaturday.sponge.menu.anvil.NameChangeMenu;
...
public class SSRename extends AbstractSpongeCommand
{
    public SSRename()
    {
        super(Commands.RENAME_NAME, Commands.RENAME_DESC, new SpongeCommandUsage(Arrays.asList(new SpongeCommandArgument(Commands.SS_CMD), new SpongeCommandArgument(Commands.RENAME_NAME), new SpongeCommandArgument(Commands.BUILD, Syntax.REQUIRED, Syntax.REPLACE)), 1), new SpongeCommandPermissions(Permissions.SUBMIT, true));
    }
