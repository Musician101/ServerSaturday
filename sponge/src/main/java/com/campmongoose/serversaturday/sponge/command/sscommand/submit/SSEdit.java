...
public class SSEdit extends AbstractSpongeCommand
{
    public SSEdit()
    {
        super(Commands.EDIT_NAME, Commands.EDIT_DESC, new SpongeCommandUsage(Arrays.asList(new SpongeCommandArgument(Commands.SS_CMD), new SpongeCommandArgument(Commands.EDIT_NAME), new SpongeCommandArgument(Commands.BUILD, Syntax.REPLACE, Syntax.OPTIONAL))), new SpongeCommandPermissions(Permissions.SUBMIT, true));
    }
