...
import com.campmongoose.serversaturday.sponge.menu.anvil.ResourcePackChangeMenu;
...
public class SSResourcePack extends AbstractSpongeCommand
{
    ...
    {
        super(Commands.RESOURCE_PACK_NAME, Commands.RESOURCE_PACK_DESC, new SpongeCommandUsage(Arrays.asList(new SpongeCommandArgument(Commands.SS_CMD), new SpongeCommandArgument(Commands.RESOURCE_PACK_NAME), new SpongeCommandArgument(Commands.BUILD, Syntax.REQUIRED, Syntax.REPLACE)), 1), new SpongeCommandPermissions(Permissions.SUBMIT, true));
    }
