...
public class UUIDUtils {
    ...
    public static Map<String, UUID> getUUIDs(List<String> names) throws IOException {
        ...
        for (String name : names) {
            ...
            MinecraftProfile profile = new GsonBuilder().registerTypeHierarchyAdapter(MinecraftProfile.class, new MinecraftProfileTypeAdapter()).create().fromJson(new InputStreamReader(connection.getInputStream()), MinecraftProfile.class);
            map.put(profile.getName().toLowerCase(), profile.getUUID());
        }
