...
public abstract class ChestGUIBuilder<B extends ChestGUIBuilder<B, C, G, I, P, S, T>, C, G extends ChestGUI<C, I, P, S, T>, I, P, S, T> implements Builder<B, G> {
    ...
    @Nonnull
    public final <O> B setContents(@Nonnull C clickType, @Nonnull List<O> contents, @Nonnull Function<O, S> itemStackMapper, @Nullable Function<O, Consumer<P>> actionMapper) {
    ...
    @Nonnull
    public B setPlayer(@Nonnull P player) {
        this.player = player;
        return (B) this;
    }
