...
public abstract class ChestGUIs<B extends ChestGUIBuilder<B, C, G, I, P, S, T>, C, G extends ChestGUI<C, I, P, S>, I, L extends Build<L, S, N, U, T>, N, P, S, T, U extends Submitter<L, S, N, U, T>> {
    ...
    @Nonnull
    protected abstract <O> B paged(@Nonnull T name, @Nonnull P player, int page, @Nonnull C clickType, @Nonnull List<O> contents, @Nonnull Function<O, S> itemStackMapper, @Nullable Function<O, Runnable> actionMapper, @Nonnull Consumer<Integer> pageNavigator);
