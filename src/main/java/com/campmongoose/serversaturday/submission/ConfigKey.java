...
public sealed abstract class ConfigKey<V> permits NonRequiredKey, RequiredKey {
    ...
    public static <V> RequiredKey<V> requiredKey(String key, Class<V> type) {
    ...
    public static <V> NonRequiredKey<V> nonRequiredKey(String key, Class<V> type) {
    ...
    public static <V> NonRequiredKey<V> nonRequiredKey(String key, Class<V> type, @Nullable V defaultValue) {
