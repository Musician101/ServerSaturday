...
{
    public SSView(ServerSaturday plugin)
    {
        super(plugin, "view", "View Server Saturday submissions.", Arrays.asList(new CommandArgument(Commands.SS_CMD), new CommandArgument("view"), new CommandArgument("player", Syntax.OPTIONAL, Syntax.REPLACE), new CommandArgument("build", Syntax.OPTIONAL, Syntax.REPLACE)), 0, "ss.view", true);
    }
    ...
    public boolean onCommand(CommandSender sender, String... args)
    {
        ...
        if (args.length > 0)
        {
            ...
            {
                for (Submitter s : submissions.getSubmitters())
