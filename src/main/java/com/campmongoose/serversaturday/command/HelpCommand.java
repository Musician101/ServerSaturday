...
public class HelpCommand extends AbstractCommand
{
    ...
    public HelpCommand(ServerSaturday plugin, AbstractCommand mainCommand)
    {
        super(plugin, "help", "Display help info for " + ChatColor.stripColor(mainCommand.getUsage()), Arrays.asList(new CommandArgument(ChatColor.stripColor(mainCommand.getUsage())), new CommandArgument("help")), 1, "", false);
