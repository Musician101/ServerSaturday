...
public class SpongeCommands {
    ...
    public static void init(SpongeServerSaturday plugin) {
        ...
        cm.register(plugin, CommandSpec.builder().description(of(Commands.HELP_DESC))
                .executor(new SSCommand()).build(), fullPrefix, shortPrefix);

        cm.register(plugin, CommandSpec.builder().description(of(Commands.DESCRIPTION_DESC))
        ...
        cm.register(plugin, CommandSpec.builder().extendedDescription(of(Commands.EDIT_DESC))
        ...
        cm.register(plugin, CommandSpec.builder().description(of(Commands.LOCATION_DESC))
        ...
        cm.register(plugin, CommandSpec.builder().description(of(Commands.NEW_DESC))
        ...
        cm.register(plugin, CommandSpec.builder().description(of(Commands.REMOVE_DESC))
        ...
        cm.register(plugin, CommandSpec.builder().description(of(Commands.RENAME_DESC))
        ...
        cm.register(plugin, CommandSpec.builder().description(of(Commands.RESOURCE_PACK_DESC))
        ...
        cm.register(plugin, CommandSpec.builder().description(of(Commands.SUBMIT_DESC))
        ...
        cm.register(plugin, CommandSpec.builder().description(of(Commands.GOTO_DESC))
        ...
        cm.register(plugin, CommandSpec.builder().description(of(Commands.VIEW_DESC)).arguments(new SubmitterCommandElement())
        ...
        cm.register(plugin, CommandSpec.builder().description(of(Commands.VIEW_DESCRIPTION_DESC))
        ...
        cm.register(plugin, CommandSpec.builder().description(of(Commands.FEATURE_DESC))
        ...
        cm.register(plugin, CommandSpec.builder().description(of(Commands.RELOAD_DESC))
