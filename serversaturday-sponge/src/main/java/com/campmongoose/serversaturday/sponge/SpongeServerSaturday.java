...
public class SpongeServerSaturday implements ServerSaturday<SpongeBuild, ItemStack, ClientConnectionEvent.Join, Location<World>, Player, SpongeRewardGiver, SpongeSubmissions, Text, SpongeSubmitter> {
